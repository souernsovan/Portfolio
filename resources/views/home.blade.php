    ...
    <main id="top">
        ...
        <section class="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-24 pt-20 text-center sm:pt-28">
            ...
            @if($profile && ($profile->github_url || $profile->linkedin_url || $profile->twitter_url))
                <div class="reveal mt-6 flex items-center justify-center gap-3" style="--reveal-delay: 360ms">
                    @if($profile->github_url)
                        <a href="{{ $profile->github_url }}" target="_blank" rel="noopener" aria-label="GitHub"
                           class="circle-btn flex h-10 w-10 items-center justify-center rounded-full">
                    ...
                    @if($profile->twitter_url)
                        <a href="{{ $profile->twitter_url }}" target="_blank" rel="noopener" aria-label="Twitter"
                           class="circle-btn flex h-10 w-10 items-center justify-center rounded-full">
